...
export default function Resume() {
  return (
    <div style={styles.body} className=" " id="resume">
      <div className="fixed right-6 w-24 h-12 p-0.5 flex text-white  bg-black bg-opacity-60 rounded-full">
        <NavLink
      ...
      <div style={styles.pdfPage} id="pdfPage">
        {/* Heading */}
        <div className=" text-center">
          <h1 className="text-4xl font-semibold"><a href="https://shubhjena.github.io/" target="blank">Shubhashish Jena</a></h1>
          <p className="text-sm">
            +91-762-189-0244 |{" "}
              ...
              <li key={index} className="mt-2">
                <h3 className="text-md font-semibold">
                  ...
                  <span className="font-normal float-right text-sm">
                    <a href={project.url} target="blank">{project.urlText}</a>
                  </span>
                </h3>
        ...
        <div className="mt-3">
          ...
          <ul className="list-none ml-6">
            ...
            <li className="mt-2 mr-2">
              <h3 className="text-md font-semibold inline-block">IIT Madras</h3>
            ...
            <li className="mt-2 mr-2">
              ...
              <p className="italic text-sm mt-0.5">
                <span></span>Bachelor of Engineering in Civil Engineering - CGPA
                8.45<span className="float-right">Aug. 2015 -- June 2019</span>
              </p>
            </li>
          </ul>
        </div>
